        ...
        <div>
            <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
                ...
                <button
                    ...
                    className="inline-flex items-center gap-2 rounded-lg bg-blue-600 hover:bg-blue-700 px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-blue-500/20 cursor-pointer transition"
                >
