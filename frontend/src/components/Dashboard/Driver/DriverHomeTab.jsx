    ...
    return (
        <div className="space-y-6">
            ...
            <div className="rounded-2xl border-2 border-blue-700 bg-white p-6 shadow-sm">
                ...
                <h2 className="text-xl font-bold text-slate-800">Zone B-42: Front Library</h2>

                <div className="mt-6 grid gap-4 md:grid-cols-[repeat(3,minmax(0,1fr))_auto] md:items-center">
                    <StatBox label="Permit Vehicle" value="ABC-1234 (Tesla M3)" />
                    <StatBox label="Checked In At" value="08:45 AM Today" />
